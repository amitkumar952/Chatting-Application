...
public class Client  implements ActionListener {
    ...
    Client(){   //object banate hi cunstractor call hota hai
        ...
        JLabel name = new JLabel("Abhishek Verma ");
...
//        JLabel output = new JLabel(out);
    ...
    public static void main(String[] args){
        new Client(); // esa likhte hai object ko to bo Annumous object bola jata hai
        
        try{
           Socket s = new Socket("127.0.0.1", 6001); //socket ke jariye aap server se connect ho gye ho
